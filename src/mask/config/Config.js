...
export default class Config extends PIXI.utils.EventEmitter
{
    ...
    {
        return './../assets/img/background0.png';
    }
    ...
    {
        return [
            './../assets/img/mask-oval.png',
            './../assets/img/mask-polygon.png',
            './../assets/img/mask-round-squre.png',
            './../assets/img/mask-round-star.png',
            './../assets/img/mask-star.png',
            './../assets/img/mask-star-2.png',
            './../assets/img/mask-triangle.png'
        ];
    }
