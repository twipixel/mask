...
export default class StrokeTest extends PIXI.utils.EventEmitter
{
    ...
    initialize()
    {
        ...
        backgroundImage.on(BackgroundImage.READY, () => {
            this.startTest(svgContainer);
            //this.addDatGui();
        });
    }
    ...
    startTest(svgContainer)
    {
        request(maskURL)
            .then(responseText => {
                this.display(svgContainer, responseText);
            })
            .catch(e => {
    ...
    display(svgContainer, responseText)
    {
        ...
        /**
         * fill-opacity 값을 0 으로 주면 가운데가 뚫린 도형을 그릴 수 있습니다.
         */
    ...
    addDatGui()
    {
        this.datGui = DatGuiStroke.instance;
        this.datGui.initialize(null);
    }
